...
HD_PWD='D:/VM_share/NVDLA_BP/spinal_prj/vivado/nvdla_bp/nvdla_bp.runs/fp_multi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_multi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_multi.tcl
