...
#
# Generated by export_simulation on Thu Oct 07 14:24:30 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './fp_adder_bb.sh' script.

./fp_adder_bb.sh -reset_run
...
./fp_adder_bb.sh -noclean_files

For more information on the script, please type './fp_adder_bb.sh -help'.
