...
#
# Generated by Vivado on Sat Oct 09 22:31:39 +0800 2021
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: fp_multi_bb.sh [-help]
# usage: fp_multi_bb.sh [-lib_map_path]
# usage: fp_multi_bb.sh [-noclean_files]
# usage: fp_multi_bb.sh [-reset_run]
#
...
# executing this script. Please type 'fp_multi_bb.sh -help' for more information.
#
...
# Script info
echo -e "fp_multi_bb.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../nvdla_bp.srcs/sources_1/ip/fp_multi_bb/sim/fp_multi_bb.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_multi_bb -o fp_multi_bb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_multi_bb_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fp_multi_bb.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fp_multi_bb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp_multi_bb_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp_multi_bb.sh -help\" for more information)\n"
    exit 1
  fi
